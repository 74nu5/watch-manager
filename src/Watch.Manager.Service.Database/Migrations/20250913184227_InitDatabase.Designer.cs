...
namespace Watch.Manager.Service.Database.Migrations
{
    ...
    [Migration("20250913184227_InitDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Watch.Manager.Service.Database.Entities.Article", b =>
                {
                    ...
                    b.Property<SqlVector<float>>("EmbeddingBody")
                        .HasColumnType("vector(1536)");

                    b.Property<SqlVector<float>>("EmbeddingHead")
                        .HasColumnType("vector(1536)");
            ...
            modelBuilder.Entity("Watch.Manager.Service.Database.Entities.Category", b =>
                {
                    ...
                    b.Property<double>("AutoThreshold")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("ManualThreshold")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Watch.Manager.Service.Database.Entities.SavedSearch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
